...
public class MainActivity extends AppCompatActivity {
    ...
    public void cargarDatos(){
        lista.add(new Inmueble(R.drawable.casa1,"9 de Julio 12822" , 85000));
        lista.add(new Inmueble(R.drawable.casa2,"9 de Julio 12822" , 85000));
        lista.add(new Inmueble(R.drawable.casa3,"9 de Julio 12822" , 85000));
    }
}